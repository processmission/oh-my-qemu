...
If no task name is given, the script uses the current directory name as the slug. After it runs, report the created workspace path and slug, then point the user to the `qemu-plan` skill as the next step.

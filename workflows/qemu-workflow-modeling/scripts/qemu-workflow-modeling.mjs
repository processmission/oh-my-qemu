...
const WORKSTREAM_CHAINS = {
  "register-extraction": ["qemu-plan", "qemu-source-provenance", "qemu-register-extraction"],
  "peripheral-modeling": [
    "qemu-plan",
  ...
  "board-modeling": [
    ...
    "qemu-qtest",
    "qemu-workflow-direct-linux-boot",
    "qemu-model-verification",
    "qemu-rst-documentation",
    "qemu-rlcr-loop",
  ],
  build: ["qemu-plan", "qemu-source-provenance", "qemu-build"],
  "kernel-build": ["qemu-plan", "qemu-source-provenance", "qemu-kernel-build"],
  "uboot-build": ["qemu-plan", "qemu-source-provenance", "qemu-uboot-build"],
  "image-packaging": ["qemu-plan", "qemu-source-provenance", "qemu-image-layout", "qemu-image-packaging"],
  "direct-linux-boot": [
    "qemu-plan",
    "qemu-source-provenance",
    "qemu-image-layout",
  ...
  "firmware-linux-boot": [
    ...
    "qemu-image-layout",
    "qemu-boot-run",
    "qemu-workflow-firmware-linux-boot",
    "qemu-debug",
    "qemu-model-verification",
  ],
  debug: ["qemu-plan", "qemu-boot-run", "qemu-debug", "qemu-model-verification"],
  qtest: ["qemu-plan", "qemu-qtest", "qemu-model-verification"],
  documentation: ["qemu-plan", "qemu-rst-documentation"],
  "tcg-frontend": ["qemu-plan", "qemu-workflow-tcg-frontend-instruction", "qemu-build", "qemu-rlcr-loop"],
  "tcg-backend": ["qemu-plan", "qemu-workflow-tcg-backend-adaptation", "qemu-build", "qemu-rlcr-loop"],
  general: ["qemu-plan", "qemu-source-provenance", "qemu-model-verification", "qemu-rlcr-loop"],
};
...
if (mode === "bootstrap") {
  ...
  throw new Error(`unknown qemu-workflow-modeling mode: ${mode}`);
}
...
async function recordProvenance() {
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-modeling provenance -->",
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-modeling source-provenance -->",
...
async function writeHandoff() {
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-modeling handoff -->",
...
async function recordRound() {
  ...
  await appendSectionOnce(
    join(taskRoot, "evidence.md"),
    `<!-- qemu-workflow-modeling round ${round} attempt ${attempt} -->`,
...
function slugify(input) {
  const slug = input
    ...
    .replace(/^-+|-+$/g, "")
    .slice(0, 80);
  return slug || "qemu-workflow-modeling";
}

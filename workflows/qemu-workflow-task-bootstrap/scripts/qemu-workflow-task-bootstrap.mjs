...
const WORKSTREAM_CHAINS = {
  ...
  "tcg-frontend": ["qemu-plan", "qemu-workflow-tcg-frontend-instruction", "qemu-rlcr-loop"],
  "tcg-backend": ["qemu-plan", "qemu-workflow-tcg-backend-adaptation", "qemu-rlcr-loop"],
...
if (mode === "bootstrap") {
  ...
  throw new Error(`unknown qemu-workflow-task-bootstrap mode: ${mode}`);
}
...
async function recordProvenance() {
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-task-bootstrap provenance -->",
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-task-bootstrap source-provenance -->",
...
async function writeHandoff() {
  ...
  await appendSectionOnce(
    ...
    "<!-- qemu-workflow-task-bootstrap handoff -->",
